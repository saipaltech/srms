...
export class ApproveDirectVoucherService {
  ...
  approveVoucher(id: any){
    return this.http.post(this.url + '/approvedirectbankvoucher/'+ id, {id:id})
  }
  ...
  getList(perPage: string | number, page: string | number, searchTerm?: string, sortKey?: string, sortDir?: boolean, approve?: string) {
    ...
    return this.http.get(this.url+'/getDirectbank' + urlPart);
