...
import { ApproveDirectVoucherService } from './approve-direct-voucher.service';



@Component({
  selector: 'app-approve-direct-voucher',
  templateUrl: './approve-direct-voucher.component.html',
  styleUrls: ['./approve-direct-voucher.component.scss'],
  providers: [DatePipe]
})
export class ApproveDirectVoucherComponent implements OnInit {
  ...
  constructor(private appconfig:AppConfig ,private datePipe: DatePipe, private toastr: ToastrService, private fb: FormBuilder, private bvs: ApproveDirectVoucherService, private modalService: BsModalService, private r: Router, private auth: AuthService) {
