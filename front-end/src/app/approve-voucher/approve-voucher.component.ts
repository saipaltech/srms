...
import { ApproveVoucherService } from './approve-voucher.service';


@Component({
  selector: 'app-approve-voucher',
  templateUrl: './approve-voucher.component.html',
  styleUrls: ['./approve-voucher.component.scss']
})
...
constructor(private datePipe: DatePipe, private toastr: ToastrService, private fb: FormBuilder,private bvs:ApproveVoucherService, private modalService: BsModalService){
