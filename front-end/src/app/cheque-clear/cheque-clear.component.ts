...
@Component({
  selector: 'app-cheque-clear',
  templateUrl: './cheque-clear.component.html',
  styleUrls: ['./cheque-clear.component.scss'],
  providers: [DatePipe]
})
export class ChequeClearComponent implements OnInit {
...
constructor(private appconfig:AppConfig,private datePipe: DatePipe,private bs:BankService, private toastr: ToastrService, private fb: FormBuilder,private bvs:ChequeClearService, private modalService: BsModalService, private r: Router,private auth:AuthService){
