...
import { VerifyVoucherPortalService } from './verify-voucher-portal.service';
import { ValidationService } from '../validation.service';
import { DatePipe } from '@angular/common';


@Component({
  selector: 'app-verify-voucher-portal',
  templateUrl: './verify-voucher-portal.component.html',
  styleUrls: ['./verify-voucher-portal.component.scss'],
  providers: [DatePipe]
})
export class VerifyVoucherPortalComponent {
  ...
  constructor(private toastr: ToastrService, private fb: FormBuilder, private RS: VerifyVoucherPortalService, private datePipe: DatePipe) {
