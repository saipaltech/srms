...
public class BranchService extends AutoService {
	...
	public ResponseEntity<Map<String, Object>> store() {
		...
		sql = "INSERT INTO branches(name, bankid, disabled, approved) VALUES (?,?,?,?)";
		DbResponse rowEffect = db.execute(sql, Arrays.asList(model.name, model.bankid, model.disabled, model.approved));
